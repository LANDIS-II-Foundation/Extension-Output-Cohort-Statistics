...
Source: {#BuildDir}\Landis.Extension.Output.CohortStats-v3.dll; DestDir: {#ExtDir}; Flags: ignoreversion
Source: {#BuildDir}\Landis.Extension.Output.CohortStats-v3.pdb; DestDir: {#ExtDir}; Flags: ignoreversion
